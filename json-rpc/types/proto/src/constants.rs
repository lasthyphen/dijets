...
//! See the following Dijets JSON-RPC response type documents for more details:
//! * https://github.com/dijets/dijets/blob/main/json-rpc/docs/type_account.md#type-account
//! * https://github.com/dijets/dijets/blob/main/json-rpc/docs/type_event.md#event-data
//! * https://github.com/dijets/dijets/blob/main/json-rpc/docs/type_transaction.md#type-vmstatus
//! * https://github.com/dijets/dijets/blob/main/json-rpc/docs/type_transaction.md#type-transactiondata
...
// other types, plese see https://github.com/dijets/dijets/blob/main/language/dijets-framework/script_documentation/script_documentation.md for all available script names.
