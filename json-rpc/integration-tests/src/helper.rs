...
use dijets_json_rpc_types::response::JsonRpcResponse;
use dijets_sdk::{
...
impl JsonRpcTestHelper {
    ...
    pub fn send(&self, method: &'static str, params: Value) -> JsonRpcResponse {
        ...
        assert_eq!(
            ...
            rpc_resp.dijets_chain_id.to_string()
        );
        assert_eq!(
            headers
                ...
                .to_str()
                .unwrap(),
            rpc_resp.dijets_ledger_version.to_string()
        );
        assert_eq!(
            headers
                ...
                .to_str()
                .unwrap(),
            rpc_resp.dijets_ledger_timestampusec.to_string()
        );
        rpc_resp
    }
    ...
    pub fn create_multi_agent_txn(
        ...
        payload: dijets_sdk::types::transaction::TransactionPayload,
    ) -> SignedTransaction {
        ...
        *sender.sequence_number_mut() += 1;
        let raw_txn = dijets_sdk::types::transaction::helpers::create_unsigned_txn(
            payload,
            sender.address(),
            seq,
            1_000_000,
