...
impl SdkLang {
    ...
    pub fn from_str(user_agent_part: &str) -> SdkLang {
        match str::trim(user_agent_part) {
            "dijets-client-sdk-rust" => SdkLang::Rust,
            "dijets-client-sdk-java" => SdkLang::Java,
            "dijets-client-sdk-python" => SdkLang::Python,
            "dijets-client-sdk-typescript" => SdkLang::Typescript,
            "dijets-client-sdk-golang" => SdkLang::Go,
            "dijets-client-sdk-csharp" => SdkLang::CSharp,
            "dijets-client-sdk-cpp" => SdkLang::Cpp,
            _ => SdkLang::Unknown,
        }
    }
...
impl SdkInfo {
    pub fn from_user_agent(user_agent: &str) -> SdkInfo {
        // parse our sdk user agent strings, i.e `dijets-client-sdk-python / 0.1.12`
