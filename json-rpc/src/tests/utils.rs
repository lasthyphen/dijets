...
use dijets_mempool::{MempoolClientSender, SubmissionStatus};
use dijets_types::{
...
use dijetsdb::test_helper::arb_blocks_to_commit;

use crate::tests::genesis::generate_genesis_state;
use dijets_client::BlockingClient;
use dijets_proptest_helpers::ValueGenerator;
use dijets_types::account_config::FreezingBit;
use futures::channel::{
...
pub fn test_bootstrap(
    address: SocketAddr,
    dijets_db: Arc<dyn MoveDbReader>,
...
/// Lightweight mock of DijetsDB
#[derive(Clone)]
#[allow(unused)]
pub struct MockDijetsDB {
    pub version: u64,
...
impl DbReader for MockDijetsDB {
...
impl ModuleResolver for MockDijetsDB {
...
impl ResourceResolver for MockDijetsDB {
    type Error = anyhow::Error;
...
impl MoveDbReader for MockDijetsDB {}

// returns MockDijetsDB for unit-testing
#[allow(unused)]
pub fn mock_db() -> MockDijetsDB {
...
/// Creates and returns a MockDijetsDB, JsonRpcAsyncClient and corresponding server Runtime tuple for
/// testing. The given channel_buffer specifies the buffer size of the mempool client sender channel.
#[allow(unused)]
pub fn create_database_client_and_runtime() -> (MockDijetsDB, BlockingClient, Runtime) {
