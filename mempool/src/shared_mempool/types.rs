...
use dijets_types::{
    ...
    on_chain_config::{ConfigID, DijetsVersion, OnChainConfig, OnChainConfigPayload, VMConfig},
...
const MEMPOOL_SUBSCRIBED_CONFIGS: &[ConfigID] = &[DijetsVersion::CONFIG_ID, VMConfig::CONFIG_ID];
