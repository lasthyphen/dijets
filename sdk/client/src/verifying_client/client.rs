...
/// The `VerifyingClient` is a [Dijets JSON-RPC client] that verifies Dijets's
...
///
/// [Dijets JSON-RPC client]: https://github.com/dijets/dijets/blob/master/json-rpc/json-rpc-spec.md
#[derive(Clone, Debug)]
