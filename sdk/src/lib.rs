...
//! The official Rust SDK for Dijets.
//!
//! ## Modules
//!
//! This SDK provides all the necessary components for building on top of the Dijets Blockchain. Some of the important modules are:
//!
//! * `client` - Includes a [JSON-RPC client](https://github.com/dijets/dijets/blob/master/json-rpc/json-rpc-spec.md) implementation
//! * `crypto` - Types used for signing and verifying
//! * `transaction_builder` - Includes helpers for constructing transactions
//! * `types` - Includes types for Dijets on-chain data structures
//!
//! ## Example
//!
...
//! let client = BlockingClient::new("http://testnet.dijets.com/v1");
//! let faucet = FaucetClient::new("http://testnet.dijets.com/mint".to_owned(), "http://testnet.dijets.com/v1".to_owned());
...
pub mod client {
    pub use dijets_client::*;
}

pub mod crypto {
    pub use dijets_crypto::*;
}
