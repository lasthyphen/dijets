...
//! We use Noise to secure connections between peers in Dijets.
...
//! use dijets_config::{config::{Peer, PeerRole, RoleType}, network_id::{NetworkContext, NetworkId}};
//! use dijets_crypto::{x25519, ed25519, Uniform, PrivateKey, test_utils::TEST_SEED};
...
//! [crypto]: ../dijets_crypto/noise/index.html
