...
//! This module defines the DijetsNet v1 message types, how they are
...
//!
//! The [DijetsNet specification](https://github.com/dijets/dijets/blob/main/specifications/network/messaging-v1.md)
//! describes in greater detail how these messages are sent and received
//! over-the-wire.

use crate::protocols::wire::handshake::v1::ProtocolId;
use bytes::Bytes;
use dijets_rate_limiter::{async_lib::AsyncRateLimiter, rate_limit::SharedBucket};
use futures::{
