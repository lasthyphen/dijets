...
//! Implementation of the unary RPC protocol as per [DijetsNet wire protocol v1].
//!
//! ## Design:
//!
...
//!
//! [DijetsNet wire protocol v1]: https://github.com/dijets/dijets/blob/main/specifications/network/messaging-v1.md
...
impl InboundRpcs {
    ...
    pub fn handle_inbound_request(
        &mut self,
        peer_notifs_tx: &mut dijets_channel::Sender<ProtocolId, PeerNotification>,
        request: RpcRequest,
    ) -> Result<(), RpcError> {
