...
use dijets_crypto::{test_utils::TestDijetsCrypto, Signature};
use dijets_vault_client::dev::{self, ROOT_TOKEN};
...
/// A test for verifying VaultStorage properly implements the DijetsSecureStorage API and enforces
...
fn test_vault_crypto_policies() {
    ...
    let message = TestDijetsCrypto("Hello, World".to_string());
