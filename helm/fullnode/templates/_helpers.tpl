...
*/}}
{{- define "dijets-fullnode.fullname" -}}
...
Common labels
*/}}
{{- define "dijets-fullnode.labels" -}}
helm.sh/chart: {{ include "dijets-fullnode.chart" . }}
{{ include "dijets-fullnode.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dijets-fullnode.selectorLabels" -}}
app.kubernetes.io/part-of: {{ include "dijets-fullnode.name" . }}
...
*/}}
{{- define "dijets-fullnode.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "dijets-fullnode.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}
{{- end -}}

{{- define "dijets-fullnode.backupEnvironment" -}}
...
{{ include "dijets-fullnode.fullname" . }}
{{- end -}}

{{- define "backup.labels" -}}
{{ include "dijets-fullnode.labels" . }}
{{- end -}}
...
{{ include "dijets-fullnode.serviceAccountName" . }}
{{- end -}}

{{- define "backup.backupService" -}}
{{ include "dijets-fullnode.fullname" . }}:6186
{{- end -}}

{{- define "backup.persistentVolumeClaim" -}}
{{ include "dijets-fullnode.fullname" . }}-e{{ .Values.chain.era }}
{{- end -}}
