...
script {
    ...
    let account = &account;
        ...
        DijetsAccount::pay_from<XUS>(&with_cap, @{{alice}}, 1, x"", x"");
...
fun main(account: signer) {
    let account = &account;
    let with_cap = DijetsAccount::extract_withdraw_capability(account);
    DijetsAccount::pay_from<XUS>(&with_cap, @{{otherblessed}}, 1, x"", x"");
    DijetsAccount::restore_withdraw_capability(with_cap)
}
}
// TODO: fix
...
script {
    ...
    let tc_account = &tc_account;
        AccountLimits::update_limits_definition<XDX>(tc_account, @DijetsRoot, 2, 2, 0, 0);
    }
}
...
script {
    ...
    let account = &account;
        let with_cap = DijetsAccount::extract_withdraw_capability(account);
        DijetsAccount::pay_from<XUS>(&with_cap, @{{bob}}, 3, x"", x"");
        DijetsAccount::restore_withdraw_capability(with_cap)
    }
}
...
script {
    ...
    fun main(tc_account: signer) {
    let tc_account = &tc_account;
        AccountLimits::update_limits_definition<XDX>(tc_account, @DijetsRoot, 1000, 1000, 1000, 0);
    }
}
...
fun main(account: signer) {
    let account = &account;
    let with_cap = DijetsAccount::extract_withdraw_capability(account);
    DijetsAccount::pay_from<XUS>(&with_cap, @{{otherblessed}}, 2, x"", x"");
    DijetsAccount::restore_withdraw_capability(with_cap);
}
}
// check: "Keep(EXECUTED)"
...
fun main(account: signer) {
    let account = &account;
    let with_cap = DijetsAccount::extract_withdraw_capability(account);
    DijetsAccount::pay_from<XUS>(&with_cap, @{{bob}}, 2, x"", x"");
    DijetsAccount::restore_withdraw_capability(with_cap);
}
}
// check: "Keep(EXECUTED)"
...
script {
    ...
    let account = &account;
        let with_cap = DijetsAccount::extract_withdraw_capability(account);
        DijetsAccount::pay_from<XUS>(&with_cap, @{{bob}}, 100, x"", x"");
        DijetsAccount::restore_withdraw_capability(with_cap);
    }
}
// check: "Keep(EXECUTED)"
...
script {
    ...
    let account = &account;
        let with_cap = DijetsAccount::extract_withdraw_capability(account);
        DijetsAccount::pay_from<XUS>(&with_cap, @{{bob}}, 1, x"", x"");
        DijetsAccount::restore_withdraw_capability(with_cap);
    }
}
// TODO: fix
...
script {
    ...
    let account = &account;
        let with_cap = DijetsAccount::extract_withdraw_capability(account);
        DijetsAccount::pay_from<XUS>(&with_cap, @{{alice}}, 101, x"", x"");
        DijetsAccount::restore_withdraw_capability(with_cap);
    }
}
// chec: ABORTED
