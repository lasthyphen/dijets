...
module {{default}}::ApprovedPayment {
    ...
    struct T has key {
        ...
        // DijetsAccount, which is a hash of a public key + signature scheme identifier.
    ...
    public fun deposit<Token>(
        ...
        //DijetsAccount::deposit_with_metadata<Token>(payer, payee, coin, metadata, x"")
        // TODO: DijetsAccount APIs no longer support depositing a coin stored in a local
    ...
    public fun deposit_to_payee<Token>(
        ...
        deposit<Token>(
            ...
            payee,
            // TODO: DijetsAccount APIs no longer support withdrawing a coin into a local
            //DijetsAccount::withdraw_from<Token>(&with_cap, amount),
            Dijets::zero<Token>(),
            metadata,
            signature
        );
