...
// The dijets root account may trigger bulk update to incorporate
...
script {
    ...
    let account = &account;
        ...
        assert(ValidatorConfig::get_consensus_pubkey(&DijetsSystem::get_validator_config(@{{bob}})) ==
        ...
        let validator_config = DijetsSystem::get_validator_config(@{{bob}});
