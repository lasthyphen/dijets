...
fn dijets_root_folder() -> PathBuf {
    let mut dijets_root_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
    dijets_root_dir.pop();
    dijets_root_dir.pop();
    dijets_root_dir.pop();
    dijets_root_dir
...
impl NodeInfo {
    pub fn new_local() -> Self {
        ...
        let builder = dijets_genesis_tool::validator_builder::ValidatorBuilder::new(
            &config_path,
        ...
        let test_config =
            dijets_genesis_tool::swarm_config::SwarmConfig::build(&builder, &config_path).unwrap();
        ...
        let child_pid = std::process::Command::new("cargo")
            ...
            .current_dir(dijets_root_folder())
            .stderr(log)
            .stdout(Stdio::null())
            .spawn()
            .unwrap()
        ...
        NodeInfo {
            ...
            json_rpc,
            root_key_path: test_config.dijets_root_key_path,
