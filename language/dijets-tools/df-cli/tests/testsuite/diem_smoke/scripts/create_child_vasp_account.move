...
/// * A `DijetsAccount::SentPaymentEvent` with the `payer` field being the Parent VASP's address,
/// and payee field being `child_address`. This is emitted on the Parent VASP's
/// `DijetsAccount::DijetsAccount` `sent_events` handle.
...
/// `DijetsAccount::DijetsAccount` `received_events` handle.
///
/// # Parameters
