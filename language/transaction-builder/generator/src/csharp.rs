...
fn write_script_call_files(
    ...
    let external_definitions = crate::common::get_external_definitions("Dijets.Types");
...
using Bcs;
using Dijets.Types; // For Script, TransactionArgument, TypeTag, TransactionPayload, ScriptFunction
...
"#,
    ...
    fn output_encode_methods(&mut self) -> Result<()> {
        writeln!(
            ...
            r#"
/// <summary>
/// Build a Dijets Script from a structured value {{@link ScriptCall}}.
/// </summary>
/// <returns>
/// Encoded Script
/// </returns>
...
public static Script EncodeScript(ScriptCall call) {{
    ...
    return helper(call);
        ...
        writeln!(
            ...
            r#"
/// <summary>
/// Build a Dijets Transaction Script from a structured value {{@link ScriptFunctionCall}}.
/// </summary>
/// <returns>
...
public static TransactionPayload EncodeScriptFunction(ScriptFunctionCall call) {{
    ...
    fn output_decode_method(&mut self) -> Result<()> {
        writeln!(
            ...
            r#"
/// <summary>
/// Try to recognize a Dijets Script and convert it into a structured value Script.
/// </summary>
/// <returns>
...
"#
        ...
        writeln!(
            ...
            r#"
/// <summary>
/// Try to recognize a Dijets TransactionPayload holding a ScriptFunction and convert it into a structured value ScriptFunction.
/// </summary>
/// <returns>
    ...
    fn emit_transaction_script_encoder(
        ...
        writeln!(
            ...
            Self::quote_doc(
                ...
                "Encoded Dijets.Types.Script value.",
            ),
            abi.name(),
    ...
    fn emit_script_function_encoder(
        ...
        writeln!(
            ...
            Self::quote_doc(
                abi.doc(),
                [quoted_type_params_doc, quoted_params_doc].concat(),
                "Encoded Dijets.Types.TransactionPayload value holding a ScriptFunction.",
            ),
            abi.name(),
            [quoted_type_params, quoted_params].concat().join(", ")
        )?;
