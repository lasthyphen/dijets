...
fn write_script_call_files(
    ...
    let external_definitions = crate::common::get_external_definitions("com.dijets.types");
...
import com.dijets.types.ScriptFunction;
import com.dijets.types.TransactionPayload;
import com.dijets.types.Identifier;
import com.dijets.types.ModuleId;
import com.dijets.types.TransactionArgument;
...
"#,
    ...
    fn output_encode_method(&mut self) -> Result<()> {
        writeln!(
            ...
            r#"
/**
 * Build a Dijets {{@link com.dijets.types.Script}} from a structured value {{@link ScriptCall}}.
 *
...
public static Script encode_script(ScriptCall call) {{
    ...
    return helper.encode(call);
        ...
        writeln!(
            ...
            r#"
/**
 * Build a Dijets {{@link com.dijets.types.TransactionPayload}} from a structured value {{@link ScriptFunctionCall}}.
 *
...
public static TransactionPayload encode_script_function(ScriptFunctionCall call) {{
    ...
    fn output_decode_method(&mut self) -> Result<()> {
        writeln!(
            ...
            r#"
/**
 * Try to recognize a Dijets {{@link com.dijets.types.Script}} and convert it into a structured value {{@code ScriptCall}}.
 *
 * @param script {{@link com.dijets.types.Script}} values to decode.
...
"#
        ...
        writeln!(
            ...
            r#"
/**
 * Try to recognize a Dijets {{@link com.dijets.types.TransactionPayload}} and convert it into a structured value {{@code ScriptFunctionCall}}.
 *
 * @param payload {{@link com.dijets.types.TransactionPayload}} values to decode.
    ...
    fn emit_transaction_script_encoder(
        ...
        writeln!(
            ...
            Self::quote_doc(
                ...
                "Encoded {@link com.dijets.types.Script} value.",
            ),
            abi.name(),
    ...
    fn emit_script_function_encoder(
        ...
        writeln!(
            ...
            Self::quote_doc(
                abi.doc(),
                [quoted_type_params_doc, quoted_params_doc].concat(),
                "Encoded {@link com.dijets.types.TransactionPayload} value.",
            ),
            abi.name(),
            [quoted_type_params, quoted_params].concat().join(", ")
        )?;
