...
use crate::{
    ...
    UNFREEZE_ACCOUNT_BYTES, UPDATE_DIJETS_VERSION_BYTES, UPDATE_DUAL_ATTESTATION_LIMIT_BYTES,
    UPDATE_EXCHANGE_RATE_BYTES, UPDATE_MINTING_ABILITY_BYTES,
};
use dijets_framework_releases::legacy::transaction_scripts::*;
...
fn test_byte_patterns() {
    ...
    for script in LegacyStdlibScript::all() {
        let bytes_from_pattern = match script {
            ...
            S::UpdateDijetsVersion => UPDATE_DIJETS_VERSION_BYTES!().to_vec(),
