...
//! Test infrastructure for the Dijets VM.
//!
//! This crate contains helpers for executing tests against the Dijets VM.

use dijets_types::{transaction::TransactionStatus, vm_status::KeptVMStatus};
