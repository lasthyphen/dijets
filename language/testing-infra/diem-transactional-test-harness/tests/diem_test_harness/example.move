...
// To create new accounts for testing, you need to call functions in `mod DijetsAccount`
// as Dijets Association (or other addresses with required capabilities).
//
// You will need to provide the address of the new account, and the authentication key
// prefix, which can be generated by the tool `dijets-keygen`.
...
//# view --address 0x4777eb94491650dd3f095ce6f778acb6 --resource 0x1::DijetsAccount::DijetsAccount
