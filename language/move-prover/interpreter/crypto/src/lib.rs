...
//! This file duplicates the code in the dijets-crypto crate to support
//! - native function implementation for the stackless bytecode interpreter, and
//! - decoupling of Move crates from Dijets crates.
//!
...
//! native functions will likely be implemented in a Dijets crate (most likely
//! dijets-framework) and be passed into the VM for execution. In this way we no
//! longer need to worry about depending on dijets-crypto.
