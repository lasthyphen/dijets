...
use dijets_crypto::{ed25519::Ed25519PrivateKey, traits::SigningKey, PrivateKey, Uniform};
...
fn create_dual_attestation_payment(
    ...
    let mut domain_separator = b"@@$$DIJETS_ATTEST$$@@".to_vec();
    let message = {
...
fn add_child_currencies() {
    ...
    let dr_account = Account::new_dijets_root();
