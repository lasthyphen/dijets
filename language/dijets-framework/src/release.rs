...
use crate::{dijets_framework_named_addresses, path_in_crate, save_binary};
use log::LevelFilter;
...
/// The documentation root template for the Dijets Framework modules.
...
fn generate_module_docs(output_path: impl AsRef<Path>, with_diagram: bool) {
    ...
    move_stdlib::build_doc(
        ...
        crate::dijets_stdlib_files_no_dependencies().as_slice(),
...
fn generate_script_docs(
    ...
    move_stdlib::build_doc(
        ...
        vec![
            ...
            crate::dijets_stdlib_modules_full_path(),
        ],
        with_diagram,
        dijets_framework_named_addresses(),
    )
...
fn generate_script_abis(
    ...
    let options = move_prover::cli::Options {
        move_sources: crate::dijets_stdlib_files(),
        move_deps: vec![
            move_stdlib::move_stdlib_modules_full_path(),
            crate::dijets_stdlib_modules_full_path(),
        ],
...
fn generate_script_builder(output_path: impl AsRef<Path>, abi_paths: &[impl AsRef<Path>]) {
...

    {
        ...
        transaction_builder_generator::rust::output(&mut file, &abis, /* local types */ true)
            .expect("Failed to generate Rust builders for Dijets");
    }
...
/// Create a Dijets Framework release in the specified directory.
///
