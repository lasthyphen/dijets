...
module DijetsFramework::SharedEd25519PublicKey {
    use DijetsFramework::Authenticator;
    ...
    struct SharedEd25519PublicKey has key {
        ...
        rotation_cap: DijetsAccount::KeyRotationCapability,
    }
    ...
    public fun publish(account: &signer, key: vector<u8>) {
        let t = SharedEd25519PublicKey {
            key: x"",
            rotation_cap: DijetsAccount::extract_key_rotation_capability(account)
        };
    ...
    spec schema PublishAbortsIf {
        ...
        include RotateKey_AbortsIf {
                shared_key: SharedEd25519PublicKey {
                    key: x"",
                    rotation_cap: DijetsAccount::spec_get_key_rotation_cap(addr)
                },
                new_public_key: key
        };
    ...
    fun rotate_key_(shared_key: &mut SharedEd25519PublicKey, new_public_key: vector<u8>) {
        ...
        DijetsAccount::rotate_authentication_key(
    ...
    spec schema RotateKey_AbortsIf {
        ...
        include DijetsAccount::RotateAuthenticationKeyAbortsIf {
