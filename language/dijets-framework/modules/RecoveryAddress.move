...
module DijetsFramework::RecoveryAddress {
    use DijetsFramework::DijetsAccount::{Self, KeyRotationCapability};
    ...
    public fun publish(recovery_account: &signer, rotation_cap: KeyRotationCapability) {
        ...
        assert(
            *DijetsAccount::key_rotation_capability_address(&rotation_cap) == addr,
    ...
    spec schema PublishAbortsIf {
        ...
        aborts_if DijetsAccount::key_rotation_capability_address(rotation_cap) != addr
    ...
    public fun rotate_authentication_key(
        ...
        })
        {
            ...
            if (DijetsAccount::key_rotation_capability_address(cap) == &to_recover) {
                DijetsAccount::rotate_authentication_key(cap, new_key);
                return
            };
            i = i + 1
        };
    ...
    spec schema RotateAuthenticationKeyAbortsIf {
        ...
        aborts_if !DijetsAccount::exists_at(to_recover) with Errors::NOT_PUBLISHED;
    ...
    spec schema RotateAuthenticationKeyEnsures {
        to_recover: address;
        new_key: vector<u8>;
        ensures DijetsAccount::authentication_key(to_recover) == new_key;
    }
    ...
    acquires RecoveryAddress {
        ...
        let to_recover_address = *DijetsAccount::key_rotation_capability_address(&to_recover);
        assert(
    ...
    spec module {
        ...
        fun spec_get_rotation_caps(recovery_address: address):
            vector<DijetsAccount::KeyRotationCapability>
        {
