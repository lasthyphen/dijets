...
module DijetsFramework::VASP {
    ...
    /// Aborts if `dr_account` is not the dijets root account,
    ...
    spec publish_child_vasp_credential {
        ...
        //     `DijetsAccount::create_child_vasp_account` since this doesn't hold of the new account in the pre-state.
