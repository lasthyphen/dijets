...
#[structopt(
    name = "Dijets format generator",
    about = "Trace serde (de)serialization to generate format descriptions for Dijets types"
)]
struct Options {
    #[structopt(long, possible_values = &Corpus::variants(), default_value = "Dijets", case_insensitive = true)]
    corpus: Corpus,
