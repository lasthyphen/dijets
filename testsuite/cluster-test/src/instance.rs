...
use dijets_client::Client as JsonRpcClient;
...
impl Instance {
    ...
    /// If deleting /opt/dijets/data/* is required, call Instance::clean_date before calling
    /// Instance::start.
    pub async fn clean_data(&self) -> Result<()> {
        self.util_cmd("rm -rf /opt/dijets/data/*; ", "clean-data")
            .await
    }
