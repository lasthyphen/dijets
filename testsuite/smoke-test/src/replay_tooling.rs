...
use crate::{
    test_utils::{dijets_swarm_utils::get_dijets_debugger, setup_swarm_and_client_proxy},
    workspace_builder,
};
...
fn test_replay_tooling() {
    ...
    let json_debugger = get_dijets_debugger(&env.validator_swarm, 0);
    ...
    let script_path = workspace_builder::workspace_root()
        .join("language/dijets-tools/transaction-replay/examples/account_exists.move");
