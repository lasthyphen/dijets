...
use dijets_sdk::{
    ...
    types::{
        ...
        account_config::constants::addresses::{
            dijets_root_address, testnet_dd_account_address, treasury_compliance_account_address,
...
impl PublicUsageTest for VerifyingGetLatestMetadata {
    fn run<'t>(&self, ctx: &mut PublicUsageContext<'t>) -> ForgeResult<()> {
        ...
        assert_eq!(meta_nv.dijets_version, meta_v.dijets_version);
        assert_eq!(
