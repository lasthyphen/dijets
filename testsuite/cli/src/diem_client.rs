...
use anyhow::Result;
use dijets_client::{views, BlockingClient, Response, WaitForTransactionError};
...
/// A client connection to an AdmissionControl (AC) service. `DijetsClient` also
...
/// ### Note
///
/// `DijetsClient` will reject out-of-date responses. For example, this can happen if
///
