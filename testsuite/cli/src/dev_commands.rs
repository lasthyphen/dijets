...
impl Command for DevCommand {
    ...
    fn execute(&self, client: &mut ClientProxy, params: &[&str]) {
        let commands: Vec<Box<dyn Command>> = vec![
            ...
            Box::new(DevCommandChangeDijetsVersion {}),
...
pub struct DevCommandChangeDijetsVersion {}

impl Command for DevCommandChangeDijetsVersion {
    fn get_aliases(&self) -> Vec<&'static str> {
        vec!["change_dijets_version", "v"]
    }
    ...
    fn get_description(&self) -> &'static str {
        "Change the dijets_version stored on chain"
    }
    ...
    fn execute(&self, client: &mut ClientProxy, params: &[&str]) {
        ...
        match client.change_dijets_version(params, true) {
            Ok(_) => println!("Successfully finished execution"),
            Err(e) => println!("{}", e),
        }
    }
...
impl Command for DevSubmitWriteSet {
    ...
    fn get_description(&self) -> &'static str {
        "Submit a WriteSet with local dijets root account. Path should be a bcs serialized TransactionPayload."
    }
