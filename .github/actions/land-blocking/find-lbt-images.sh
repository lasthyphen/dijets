...
# adapted from --build-all-cti option from dijets/docker/build-aws.sh, which is how
# land blocking test builds images before running cluster-test
REPOS=(dijets/validator dijets/cluster_test dijets/init dijets/validator_tcb)
