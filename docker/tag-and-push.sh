...
# Example:
# SOURCE=dijets_validator:latest TARGET_REPO=1234567890.dkr.ecr.us-west-2.amazonaws.com/dijets_cluster_test TARGET_TAGS=master:master_39cnja0 tag-and-push.sh
