...
function usage {
  ...
  echo "-o the org to target on dockerhub.  Defaults to 'dijets'"
  echo "should be called from the root folder of the dijets project, and must have it's .git history"
}
