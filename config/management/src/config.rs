...
use dijets_types::chain_id::{self, ChainId};
...
///
/// ```
/// use dijets_management::config::ConfigPath;
/// use structopt::StructOpt;
///
...
/// // ...
/// // OPTIONS:
/// //         --config <config>    Path to a dijets-management configuration file
/// //         --test <test>
///
/// // let none  = "cmd";
...
/// Config for dijets management tools
...
pub struct ConfigPath {
    /// Path to a dijets-management configuration file
    #[structopt(long)]
...
mod tests {
    use super::*;
    use dijets_config::config::{SecureBackend, Token, VaultConfig};
    use dijets_types::chain_id::NamedChain;
