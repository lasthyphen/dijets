...
use dijets_client::{views::VMStatusView, BlockingClient};
use dijets_management::error::Error;
use dijets_types::{
...
impl JsonRpcClientWrapper {
    ...
    /// Dijets blockchain. If account is specified, only a single validator info is returned: the
