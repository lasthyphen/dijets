...
use dijets_config::{config, config::Peer, network_id::NetworkId};
use dijets_crypto::{ed25519::Ed25519PublicKey, traits::ValidCryptoMaterialStringExt, x25519};
...
const TOOL_NAME: &str = "dijets-operational-tool";
