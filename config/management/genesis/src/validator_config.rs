...
use dijets_global_constants::OWNER_ACCOUNT;
use dijets_management::{constants, error::Error, secure_backend::SharedBackend};
use dijets_types::{network_address::NetworkAddress, transaction::Transaction};
...
impl ValidatorConfig {
    pub fn execute(self) -> Result<Transaction, Error> {
        ...
        let owner_account =
            dijets_config::utils::validator_owner_account_from_name(self.owner_name.as_bytes());
