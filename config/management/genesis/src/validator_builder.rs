...
use dijets_secure_storage::{CryptoStorage, KVStorage, OnDiskStorage, Storage};
use dijets_types::{
    chain_id::ChainId,
...
const DIJETS_ROOT_NS: &str = "dijets_root";
...
impl RootKeys {
    ...
    {
        // TODO use distinct keys for dijets root and treasury
...
impl ValidatorBuilder {
        ...
        R: ::rand::RngCore + ::rand::CryptoRng,
    {
        ...
        let owner_address =
            dijets_config::utils::validator_owner_account_from_name(validator.owner().as_bytes());
    ...
    fn genesis_ceremony(
        ...
        let layout = Layout {
            ...
            dijets_root: DIJETS_ROOT_NS.into(),
            treasury_compliance: DIJETS_ROOT_NS.into(),
        };
