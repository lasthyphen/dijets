...
use dijets_config::config::{Peer, PeerRole, PeerSet};
use dijets_logger::prelude::*;
use dijets_types::{
    account_config::dijets_root_address, account_state::AccountState,
...
fn get_validator_set(client_endpoint: String) -> anyhow::Result<ValidatorSet> {
    let root_account_address = dijets_root_address();
...
mod tests {
    ...
    use dijets_crypto::{ed25519::Ed25519PrivateKey, x25519, PrivateKey as PK, Uniform};
    use dijets_types::validator_config::ValidatorConfig;
