...
//! constants within the Dijets codebase. This is useful because many different components within
//! Dijets often require access to global constant definitions (e.g., Dijets Safety Rules,
...
pub const DIJETS_ROOT_KEY: &str = "dijets_root";
