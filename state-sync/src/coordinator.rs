...
use dijets_mempool::{CommitResponse, CommittedTransaction};
use dijets_types::{
...
pub(crate) struct StateSyncCoordinator<T> {
    ...
    state_sync_to_mempool_sender: mpsc::Sender<dijets_mempool::CommitNotification>,
...
impl<T: ExecutorProxyTrait> StateSyncCoordinator<T> {
    ...
    async fn notify_mempool_of_committed_transactions(
        ...
        let req = dijets_mempool::CommitNotification {
    ...
    fn update_sync_state_metrics_and_logs(&mut self) -> Result<(), Error> {
        ...
        counters::set_timestamp(
            ...
            dijets_infallible::duration_since_epoch().as_micros() as u64,
        );
...
mod tests {
    ...
    use dijets_mempool::CommitResponse;
    use dijets_types::{
