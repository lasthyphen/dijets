...
use dijets_types::{ledger_info::LedgerInfoWithSignatures, transaction::Version};
...
pub enum TargetType {
    ...
    /// will be removed on the next breaking release: https://github.com/dijets/dijets/issues/8013
