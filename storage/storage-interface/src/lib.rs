...
use dijets_crypto::{hash::SPARSE_MERKLE_PLACEHOLDER_HASH, HashValue};
use dijets_types::{
...
impl StartupInfo {
    ...
    pub fn new_for_testing() -> Self {
        use dijets_types::on_chain_config::ValidatorSet;
...
impl From<dijets_secure_net::Error> for Error {
    fn from(error: dijets_secure_net::Error) -> Self {
        Self::ServiceError {
            error: format!("{}", error),
        }
    }
...
/// expected of a Dijets DB
pub trait DbReader: Send + Sync {
    /// See [`DijetsDB::get_epoch_ending_ledger_infos`].
    ///
    /// [`DijetsDB::get_epoch_ending_ledger_infos`]:
    /// ../dijetsdb/struct.DijetsDB.html#method.get_epoch_ending_ledger_infos
    ...
    /// See [`DijetsDB::get_transactions`].
    ///
    /// [`DijetsDB::get_transactions`]: ../dijetsdb/struct.DijetsDB.html#method.get_transactions
    fn get_transactions(
        &self,
    ...
    /// See [`DijetsDB::get_block_timestamp`].
    ///
    /// [`DijetsDB::get_block_timestamp`]:
    /// ../dijetsdb/struct.DijetsDB.html#method.get_block_timestamp
    ...
    /// See [`DijetsDB::get_latest_account_state`].
    ///
    /// [`DijetsDB::get_latest_account_state`]:
    /// ../dijetsdb/struct.DijetsDB.html#method.get_latest_account_state
    ...
    /// See [`DijetsDB::get_startup_info`].
    ///
    /// [`DijetsDB::get_startup_info`]:
    /// ../dijetsdb/struct.DijetsDB.html#method.get_startup_info
    ...
    // See [`DijetsDB::get_account_state_with_proof_by_version`].
    //
    // [`DijetsDB::get_account_state_with_proof_by_version`]:
    // ../dijetsdb/struct.DijetsDB.html#method.get_account_state_with_proof_by_version
    //
    // This is used by dijets core (executor) internally.
    ...
    /// See [`DijetsDB::get_latest_state_root`].
    ///
    /// [`DijetsDB::get_latest_state_root`]:
    /// ../dijetsdb/struct.DijetsDB.html#method.get_latest_state_root
...
/// expected of a Dijets DB. This adds write APIs to DbReader.
pub trait DbWriter: Send + Sync {
    /// Persist transactions. Called by the executor module when either syncing nodes or committing
    /// blocks during normal operation.
    /// See [`DijetsDB::save_transactions`].
    ///
    /// [`DijetsDB::save_transactions`]: ../dijetsdb/struct.DijetsDB.html#method.save_transactions
