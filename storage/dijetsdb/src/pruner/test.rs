...
use super::*;
use crate::{change_set::ChangeSet, state_store::StateStore, DijetsDB};
use dijets_crypto::HashValue;
use dijets_temppath::TempPath;
use dijets_types::{account_address::AccountAddress, account_state_blob::AccountStateBlob};
...
fn test_pruner() {
    ...
    let db = DijetsDB::new_for_test(&tmp_dir).db;
