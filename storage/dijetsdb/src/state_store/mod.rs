...
use dijets_jellyfish_merkle::{node_type::NodeKey, JellyfishMerkleTree, TreeReader, TreeWriter};
use dijets_types::{
...
type LeafNode = dijets_jellyfish_merkle::node_type::LeafNode<AccountStateBlob>;
type Node = dijets_jellyfish_merkle::node_type::Node<AccountStateBlob>;
type NodeBatch = dijets_jellyfish_merkle::NodeBatch<AccountStateBlob>;
