...
use dijets_jellyfish_merkle::node_type::NodeKey;
use dijets_types::{account_state_blob::AccountStateBlob, transaction::Version};
use schemadb::{
    define_schema,
...
type Node = dijets_jellyfish_merkle::node_type::Node<AccountStateBlob>;
