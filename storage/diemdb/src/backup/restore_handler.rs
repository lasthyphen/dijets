...
use crate::{
    ...
    transaction_store::TransactionStore, DijetsDB,
};
use anyhow::{ensure, Result};
use dijets_crypto::{hash::SPARSE_MERKLE_PLACEHOLDER_HASH, HashValue};
use dijets_jellyfish_merkle::restore::JellyfishMerkleRestore;
use dijets_types::{
...
/// Provides functionalities for DijetsDB data restore.
#[derive(Clone)]
pub struct RestoreHandler {
    db: Arc<DB>,
    pub dijetsdb: Arc<DijetsDB>,
