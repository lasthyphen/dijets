...
use dijets_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use dijets_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`dijets_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`dijets_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`dijets_types::proof::AccumulatorRangeProof`] for proof format.
