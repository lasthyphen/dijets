...
impl Value for dijets_types::account_state_blob::AccountStateBlob {}
#[cfg(any(test, feature = "fuzzing"))]
impl TestValue for dijets_types::account_state_blob::AccountStateBlob {}
...
mod test {
    use super::NibbleExt;
    use dijets_crypto::hash::{HashValue, TestOnlyHash};
    use dijets_types::nibble::Nibble;
