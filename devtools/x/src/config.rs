...
pub struct WorkspaceConfig {
    ...
    /// Move to Dijets dependencies
    pub move_to_dijets_deps: MoveToDijetsDepsConfig,
}
...
#[derive(Clone, Serialize, Deserialize, Debug, PartialEq, Eq)]
pub struct MoveToDijetsDepsConfig {
    pub dijets_crates_in_language: HashSet<String>,
