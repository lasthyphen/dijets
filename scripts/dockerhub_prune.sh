...
######################################################################################################################
# Takes a slug org/repo ( dijets/client ) and deletes all tags with release-* over 90 days and all other              #
...
######################################################################################################################
# Takes a slug org/repo ( dijets/client ) and deletes all tags with release-* over 180 days and all other
# over 2 days (assumed to be test images).
######################################################################################################################
function prune_repo {
    REPO=$1
...
prune_repo "dijets/client"
prune_repo "dijets/cluster_test"
prune_repo "dijets/init"
prune_repo "dijets/faucet"
prune_repo "dijets/tools"
prune_repo "dijets/validator"
prune_repo "dijets/validator_tcb"

#We currently overwrite, no need to delete.
#prune_repo "dijets/build_environment"
