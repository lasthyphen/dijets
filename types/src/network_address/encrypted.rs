...
use dijets_crypto::{compat::Sha3_256, hkdf::Hkdf};
...
/// also equal to the hash value `SHA3-256(b"DIJETS_ENCRYPTED_NETWORK_ADDRESS_SALT")`.
///
/// ```
/// use dijets_types::network_address::encrypted::HKDF_SALT;
/// use dijets_crypto::hash::HashValue;
///
/// let derived_salt = HashValue::sha3_256_of(b"DIJETS_ENCRYPTED_NETWORK_ADDRESS_SALT");
...
/// `EncNetworkAddress`.
///
/// [`ValidatorConfig`]: https://github.com/dijets/dijets/blob/main/language/dijets-framework/modules/doc/ValidatorConfig.md
