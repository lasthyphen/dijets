...
use dijets_crypto_derive::{BCSCryptoHash, CryptoHasher};
...
impl AccountTransactionsWithProof {
    ...
    // (Conflict-Resistant Sequence Numbers)[https://github.com/dijets/dip/blob/main/dips/dip-168.md].
    //
...
/// `Transaction` will be the transaction type used internally in the dijets node to represent the
