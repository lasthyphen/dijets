...
pub use self::{
    dijets_version::{DijetsVersion, DIJETS_MAX_KNOWN_VERSION, DIJETS_VERSION_2, DIJETS_VERSION_3},
...
impl Default for ConfigurationResource {
    fn default() -> Self {
        Self {
            ...
            events: EventHandle::new_from_address(&crate::account_config::dijets_root_address(), 16),
        }
    }
}

impl MoveStructType for ConfigurationResource {
    const MODULE_NAME: &'static IdentStr = ident_str!("DijetsConfig");
