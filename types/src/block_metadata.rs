...
pub fn new_block_event_key() -> EventKey {
    EventKey::new_from_address(&dijets_root_address(), 17)
}

/// The path to the new block event handle under a DijetsBlock::BlockMetadata resource.
pub static NEW_BLOCK_EVENT_PATH: Lazy<Vec<u8>> = Lazy::new(|| {
    let mut path = DijetsBlockResource::resource_path();
...
pub struct DijetsBlockResource {
    height: u64,
    new_block_events: EventHandle,
}

impl DijetsBlockResource {
