...
pub use move_core_types::vm_status::known_locations::{DIJETS_MODULE, DIJETS_MODULE_IDENTIFIER};

const COIN_MODULE_IDENTIFIER: &IdentStr = DIJETS_MODULE_IDENTIFIER;
