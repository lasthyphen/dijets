...
use crate::{
    account_address::AccountAddress, dijets_id_identifier::DijetsIdVaspDomainIdentifier,
    event::EventHandle,
};
use anyhow::Result;
use move_core_types::{
...
impl VASPDomains {
    ...
    pub fn get_domains_list(&self) -> Vec<DijetsIdVaspDomainIdentifier> {
        self.domains
            .iter()
...
pub struct VASPDomain {
    pub domain: DijetsIdVaspDomainIdentifier,
}

impl VASPDomain {
    pub fn domain(&self) -> &DijetsIdVaspDomainIdentifier {
        &self.domain
    }
}
