...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::dijets_logger::Value::from_serde };
    let from_display = quote! { ::dijets_logger::Value::from_display };
    let from_debug = quote! { ::dijets_logger::Value::from_debug };
    let key_new = quote! { ::dijets_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::dijets_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::dijets_logger::Visitor) {
                #(#visits)*
            }
        }
    };
