...
//! This crates provides an API for logging in dijets.
...
//! see the [coding guidelines](https://developers.dijets.com/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use dijets_logger::{info, sample, sample::{SampleRate, Sampling}};
...
//!
//! ```
//! use dijets_logger::{Level, Logger};
//!
...
pub use crate::dijets_logger::{
    DijetsLogger, DijetsLogger as Logger, DijetsLoggerBuilder, Writer, CHANNEL_SIZE,
};
pub use event::Event;
...
pub use dijets_log_derive::Schema;
