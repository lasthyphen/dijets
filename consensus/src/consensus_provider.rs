...
use dijets_mempool::ConsensusRequest;
use dijets_types::on_chain_config::OnChainConfigPayload;
...
pub fn start_consensus(
    ...
    let storage = Arc::new(StorageWriteProxy::new(node_config, dijets_db));
