...
use dijets_global_constants::{CONSENSUS_KEY, EXECUTION_KEY, OWNER_ACCOUNT, SAFETY_DATA, WAYPOINT};
...
impl PersistentSafetyStorage {
    ...
    fn initialize_(
        ...
        // storage.
        if let Err(dijets_secure_storage::Error::KeyAlreadyExists(_)) = result {
...
mod tests {
    use super::*;
    use dijets_crypto::Uniform;
    use dijets_secure_storage::InMemoryStorage;
    use dijets_types::validator_signer::ValidatorSigner;
