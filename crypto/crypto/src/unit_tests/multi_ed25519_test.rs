...
use crate::{
    ...
    test_utils::{TestDijetsCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestDijetsCrypto> = Lazy::new(|| TestDijetsCrypto("Test Message".to_string()));
fn message() -> &'static TestDijetsCrypto {
    &MESSAGE
}
