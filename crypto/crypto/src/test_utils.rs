...
pub struct TestDijetsCrypto(pub String);
...
#[cfg(any(test, feature = "fuzzing"))]
pub struct TestDijetsCryptoHasher(crate::hash::DefaultHasher);
#[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestDijetsCryptoHasher {
    #[inline]
    fn clone(&self) -> TestDijetsCryptoHasher {
        match *self {
            TestDijetsCryptoHasher(ref __self_0_0) => {
                TestDijetsCryptoHasher(::core::clone::Clone::clone(&(*__self_0_0)))
            }
        }
    }
}
#[cfg(any(test, feature = "fuzzing"))]
static TEST_DIJETS_CRYPTO_SEED: crate::_once_cell::sync::OnceCell<[u8; 32]> =
    crate::_once_cell::sync::OnceCell::new();
#[cfg(any(test, feature = "fuzzing"))]
impl TestDijetsCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestDijetsCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestDijetsCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
#[cfg(any(test, feature = "fuzzing"))]
static TEST_DIJETS_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestDijetsCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestDijetsCryptoHasher::new);
#[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestDijetsCryptoHasher {
    fn default() -> Self {
        TEST_DIJETS_CRYPTO_HASHER.clone()
    }
}
#[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestDijetsCryptoHasher {
    fn seed() -> &'static [u8; 32] {
        TEST_DIJETS_CRYPTO_SEED.get_or_init(|| {
            let name = crate::_serde_name::trace_name::<TestDijetsCrypto>()
                .expect("The `CryptoHasher` macro only applies to structs and enums.")
                .as_bytes();
...
#[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestDijetsCryptoHasher {
...
#[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestDijetsCrypto {
    type Hasher = TestDijetsCryptoHasher;
    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestDijetsCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestDijetsCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
