...
//! Noise is a [protocol framework](https://noiseprotocol.org/) which we use in Dijets to
...
//!
//! ```
//! use dijets_crypto::{noise, x25519, traits::*};
//! use rand::prelude::*;
//!
//! # fn main() -> Result<(), dijets_crypto::noise::NoiseError> {
